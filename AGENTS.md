...
> 任何新打开此项目的 AI 会话应先读这个文件。当前快照：**v0.2.5 发布准备（剪贴板粘贴 + QuickLook 预览窗 + 删除撤销 + 玻璃 perf + 托盘归位）/ 2026-08-19**。
